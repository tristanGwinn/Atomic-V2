...
class Trigger { 
    ...
    public:
        ...
        // this was in the original library, but has no documentation
        // explicit Trigger(Command* command) : Trigger([command] () {return command->scheduled(); }) {}

        /**
         * @brief Binds a function to the \refitem EventLoop and checks if the confition has changed.
         * Upon change the \refitem Command is scheduled
         * 
        ...
        /**
         * @brief Binds a function to the \refitem EventLoop checks to condition to see
         * if it has changed from false to true. Upon change the \refitem Command is scheduled
         * 
        ...
        /**
         * @brief Binds a function to the \refitem EventLoop checks to condition to see
         * if it has changed from true to false. Upon change the \refitem Command is scheduled
         * 
