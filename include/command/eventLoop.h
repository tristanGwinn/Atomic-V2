...
/**
 * @brief Event loops store user-defined bindings to be run every frame.
 * This is used mostly to control the bindings necessary for \refitem Trigger
 */
class EventLoop {
    private:
    ...
    public:
        ...
        /**
         * @brief Initialize the EventLoop with an initializer list of bindings
         * 
        ...
        /**
         * @brief Poll is run every frame and runs each of the bindings.
         * This is generally run by the \refitem CommandScheduler
         */
        void poll() {
