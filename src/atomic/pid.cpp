...
void PID::setGains(atomic::Gains gains) { m_gains = gains; }
...
void atomic::PID::reset() {
    m_previousError = 0;
    m_integral = 0;
}

void atomic::PID::setSignFlipReset(bool signFlipReset) { m_signFlipReset = signFlipReset; }

bool atomic::PID::getSignFlipReset() { return m_signFlipReset; }

void atomic::PID::setWindupRange(Number windupRange) { m_windupRange = windupRange; }

Number atomic::PID::getWindupRange() { return m_windupRange; }
